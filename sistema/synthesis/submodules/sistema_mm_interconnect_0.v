...
module sistema_mm_interconnect_0 (
		...
		output wire [1:0]  SVSD_s1_address,                        //                          SVSD_s1.address
		output wire        SVSD_s1_write,                          //                                 .write
		input  wire [31:0] SVSD_s1_readdata,                       //                                 .readdata
		output wire [31:0] SVSD_s1_writedata,                      //                                 .writedata
		output wire        SVSD_s1_chipselect,                     //                                 .chipselect
	...
	wire  [31:0] svsd_s1_agent_m0_readdata;                                                 // SVSD_s1_translator:uav_readdata -> SVSD_s1_agent:m0_readdata
	wire         svsd_s1_agent_m0_waitrequest;                                              // SVSD_s1_translator:uav_waitrequest -> SVSD_s1_agent:m0_waitrequest
	wire         svsd_s1_agent_m0_debugaccess;                                              // SVSD_s1_agent:m0_debugaccess -> SVSD_s1_translator:uav_debugaccess
	wire  [15:0] svsd_s1_agent_m0_address;                                                  // SVSD_s1_agent:m0_address -> SVSD_s1_translator:uav_address
	wire   [3:0] svsd_s1_agent_m0_byteenable;                                               // SVSD_s1_agent:m0_byteenable -> SVSD_s1_translator:uav_byteenable
	wire         svsd_s1_agent_m0_read;                                                     // SVSD_s1_agent:m0_read -> SVSD_s1_translator:uav_read
	wire         svsd_s1_agent_m0_readdatavalid;                                            // SVSD_s1_translator:uav_readdatavalid -> SVSD_s1_agent:m0_readdatavalid
	wire         svsd_s1_agent_m0_lock;                                                     // SVSD_s1_agent:m0_lock -> SVSD_s1_translator:uav_lock
	wire  [31:0] svsd_s1_agent_m0_writedata;                                                // SVSD_s1_agent:m0_writedata -> SVSD_s1_translator:uav_writedata
	wire         svsd_s1_agent_m0_write;                                                    // SVSD_s1_agent:m0_write -> SVSD_s1_translator:uav_write
	wire   [2:0] svsd_s1_agent_m0_burstcount;                                               // SVSD_s1_agent:m0_burstcount -> SVSD_s1_translator:uav_burstcount
	wire         svsd_s1_agent_rf_source_valid;                                             // SVSD_s1_agent:rf_source_valid -> SVSD_s1_agent_rsp_fifo:in_valid
	wire  [92:0] svsd_s1_agent_rf_source_data;                                              // SVSD_s1_agent:rf_source_data -> SVSD_s1_agent_rsp_fifo:in_data
	wire         svsd_s1_agent_rf_source_ready;                                             // SVSD_s1_agent_rsp_fifo:in_ready -> SVSD_s1_agent:rf_source_ready
	wire         svsd_s1_agent_rf_source_startofpacket;                                     // SVSD_s1_agent:rf_source_startofpacket -> SVSD_s1_agent_rsp_fifo:in_startofpacket
	wire         svsd_s1_agent_rf_source_endofpacket;                                       // SVSD_s1_agent:rf_source_endofpacket -> SVSD_s1_agent_rsp_fifo:in_endofpacket
	wire         svsd_s1_agent_rsp_fifo_out_valid;                                          // SVSD_s1_agent_rsp_fifo:out_valid -> SVSD_s1_agent:rf_sink_valid
	wire  [92:0] svsd_s1_agent_rsp_fifo_out_data;                                           // SVSD_s1_agent_rsp_fifo:out_data -> SVSD_s1_agent:rf_sink_data
	wire         svsd_s1_agent_rsp_fifo_out_ready;                                          // SVSD_s1_agent:rf_sink_ready -> SVSD_s1_agent_rsp_fifo:out_ready
	wire         svsd_s1_agent_rsp_fifo_out_startofpacket;                                  // SVSD_s1_agent_rsp_fifo:out_startofpacket -> SVSD_s1_agent:rf_sink_startofpacket
	wire         svsd_s1_agent_rsp_fifo_out_endofpacket;                                    // SVSD_s1_agent_rsp_fifo:out_endofpacket -> SVSD_s1_agent:rf_sink_endofpacket
	wire         cmd_mux_003_src_valid;                                                     // cmd_mux_003:src_valid -> SVSD_s1_agent:cp_valid
	wire  [91:0] cmd_mux_003_src_data;                                                      // cmd_mux_003:src_data -> SVSD_s1_agent:cp_data
	wire         cmd_mux_003_src_ready;                                                     // SVSD_s1_agent:cp_ready -> cmd_mux_003:src_ready
	wire   [7:0] cmd_mux_003_src_channel;                                                   // cmd_mux_003:src_channel -> SVSD_s1_agent:cp_channel
	wire         cmd_mux_003_src_startofpacket;                                             // cmd_mux_003:src_startofpacket -> SVSD_s1_agent:cp_startofpacket
	wire         cmd_mux_003_src_endofpacket;                                               // cmd_mux_003:src_endofpacket -> SVSD_s1_agent:cp_endofpacket
	...
	wire  [91:0] cmd_mux_004_src_data;                                                      // cmd_mux_004:src_data -> BUTTON_s1_agent:cp_data
	wire         cmd_mux_004_src_ready;                                                     // BUTTON_s1_agent:cp_ready -> cmd_mux_004:src_ready
	wire   [7:0] cmd_mux_004_src_channel;                                                   // cmd_mux_004:src_channel -> BUTTON_s1_agent:cp_channel
	...
	wire         cmd_mux_005_src_valid;                                                     // cmd_mux_005:src_valid -> BUZZER_s1_agent:cp_valid
	wire  [91:0] cmd_mux_005_src_data;                                                      // cmd_mux_005:src_data -> BUZZER_s1_agent:cp_data
	wire         cmd_mux_005_src_ready;                                                     // BUZZER_s1_agent:cp_ready -> cmd_mux_005:src_ready
	wire   [7:0] cmd_mux_005_src_channel;                                                   // cmd_mux_005:src_channel -> BUZZER_s1_agent:cp_channel
	wire         cmd_mux_005_src_startofpacket;                                             // cmd_mux_005:src_startofpacket -> BUZZER_s1_agent:cp_startofpacket
	wire         cmd_mux_005_src_endofpacket;                                               // cmd_mux_005:src_endofpacket -> BUZZER_s1_agent:cp_endofpacket
	...
	wire  [91:0] cmd_mux_006_src_data;                                                      // cmd_mux_006:src_data -> SWITCH_s1_agent:cp_data
	...
	wire         svsd_s1_agent_rp_valid;                                                    // SVSD_s1_agent:rp_valid -> router_005:sink_valid
	wire  [91:0] svsd_s1_agent_rp_data;                                                     // SVSD_s1_agent:rp_data -> router_005:sink_data
	wire         svsd_s1_agent_rp_ready;                                                    // router_005:sink_ready -> SVSD_s1_agent:rp_ready
	wire         svsd_s1_agent_rp_startofpacket;                                            // SVSD_s1_agent:rp_startofpacket -> router_005:sink_startofpacket
	wire         svsd_s1_agent_rp_endofpacket;                                              // SVSD_s1_agent:rp_endofpacket -> router_005:sink_endofpacket
	...
	wire  [91:0] button_s1_agent_rp_data;                                                   // BUTTON_s1_agent:rp_data -> router_006:sink_data
	...
	wire         buzzer_s1_agent_rp_valid;                                                  // BUZZER_s1_agent:rp_valid -> router_007:sink_valid
	wire  [91:0] buzzer_s1_agent_rp_data;                                                   // BUZZER_s1_agent:rp_data -> router_007:sink_data
	wire         buzzer_s1_agent_rp_ready;                                                  // router_007:sink_ready -> BUZZER_s1_agent:rp_ready
	wire         buzzer_s1_agent_rp_startofpacket;                                          // BUZZER_s1_agent:rp_startofpacket -> router_007:sink_startofpacket
	wire         buzzer_s1_agent_rp_endofpacket;                                            // BUZZER_s1_agent:rp_endofpacket -> router_007:sink_endofpacket
	...
	wire  [91:0] switch_s1_agent_rp_data;                                                   // SWITCH_s1_agent:rp_data -> router_008:sink_data
	...
	wire  [91:0] cmd_demux_001_src2_data;                                                   // cmd_demux_001:src2_data -> cmd_mux_007:sink1_data
	...
	wire  [91:0] rsp_demux_007_src1_data;                                                   // rsp_demux_007:src1_data -> rsp_mux_001:sink2_data
	...
	wire         svsd_s1_agent_rdata_fifo_src_valid;                                        // SVSD_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_003:in_0_valid
	wire  [33:0] svsd_s1_agent_rdata_fifo_src_data;                                         // SVSD_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_003:in_0_data
	wire         svsd_s1_agent_rdata_fifo_src_ready;                                        // avalon_st_adapter_003:in_0_ready -> SVSD_s1_agent:rdata_fifo_src_ready
	wire         avalon_st_adapter_003_out_0_valid;                                         // avalon_st_adapter_003:out_0_valid -> SVSD_s1_agent:rdata_fifo_sink_valid
	wire  [33:0] avalon_st_adapter_003_out_0_data;                                          // avalon_st_adapter_003:out_0_data -> SVSD_s1_agent:rdata_fifo_sink_data
	wire         avalon_st_adapter_003_out_0_ready;                                         // SVSD_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_003:out_0_ready
	wire   [0:0] avalon_st_adapter_003_out_0_error;                                         // avalon_st_adapter_003:out_0_error -> SVSD_s1_agent:rdata_fifo_sink_error
	...
	wire         buzzer_s1_agent_rdata_fifo_src_valid;                                      // BUZZER_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_005:in_0_valid
	wire  [33:0] buzzer_s1_agent_rdata_fifo_src_data;                                       // BUZZER_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_005:in_0_data
	wire         buzzer_s1_agent_rdata_fifo_src_ready;                                      // avalon_st_adapter_005:in_0_ready -> BUZZER_s1_agent:rdata_fifo_src_ready
	wire         avalon_st_adapter_005_out_0_valid;                                         // avalon_st_adapter_005:out_0_valid -> BUZZER_s1_agent:rdata_fifo_sink_valid
	wire  [33:0] avalon_st_adapter_005_out_0_data;                                          // avalon_st_adapter_005:out_0_data -> BUZZER_s1_agent:rdata_fifo_sink_data
	wire         avalon_st_adapter_005_out_0_ready;                                         // BUZZER_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_005:out_0_ready
	wire   [0:0] avalon_st_adapter_005_out_0_error;                                         // avalon_st_adapter_005:out_0_error -> BUZZER_s1_agent:rdata_fifo_sink_error
	...
	altera_merlin_slave_translator #(
		...
		.clk                    (CLK_clk_clk),                           //                      clk.clk
		.reset                  (CPU_reset_reset_bridge_in_reset_reset), //                    reset.reset
		.uav_address            (svsd_s1_agent_m0_address),              // avalon_universal_slave_0.address
		.uav_burstcount         (svsd_s1_agent_m0_burstcount),           //                         .burstcount
		.uav_read               (svsd_s1_agent_m0_read),                 //                         .read
		.uav_write              (svsd_s1_agent_m0_write),                //                         .write
		.uav_waitrequest        (svsd_s1_agent_m0_waitrequest),          //                         .waitrequest
		.uav_readdatavalid      (svsd_s1_agent_m0_readdatavalid),        //                         .readdatavalid
		.uav_byteenable         (svsd_s1_agent_m0_byteenable),           //                         .byteenable
		.uav_readdata           (svsd_s1_agent_m0_readdata),             //                         .readdata
		.uav_writedata          (svsd_s1_agent_m0_writedata),            //                         .writedata
		.uav_lock               (svsd_s1_agent_m0_lock),                 //                         .lock
		.uav_debugaccess        (svsd_s1_agent_m0_debugaccess),          //                         .debugaccess
		.av_address             (SVSD_s1_address),                       //      avalon_anti_slave_0.address
		.av_write               (SVSD_s1_write),                         //                         .write
		.av_readdata            (SVSD_s1_readdata),                      //                         .readdata
		.av_writedata           (SVSD_s1_writedata),                     //                         .writedata
		.av_chipselect          (SVSD_s1_chipselect),                    //                         .chipselect
		.av_read                (),                                      //              (terminated)
		.av_begintransfer       (),                                      //              (terminated)
		.av_beginbursttransfer  (),                                      //              (terminated)
		.av_burstcount          (),                                      //              (terminated)
	...
	altera_merlin_slave_agent #(
		...
		.clk                     (CLK_clk_clk),                              //             clk.clk
		.reset                   (CPU_reset_reset_bridge_in_reset_reset),    //       clk_reset.reset
		.m0_address              (svsd_s1_agent_m0_address),                 //              m0.address
		.m0_burstcount           (svsd_s1_agent_m0_burstcount),              //                .burstcount
		.m0_byteenable           (svsd_s1_agent_m0_byteenable),              //                .byteenable
		.m0_debugaccess          (svsd_s1_agent_m0_debugaccess),             //                .debugaccess
		.m0_lock                 (svsd_s1_agent_m0_lock),                    //                .lock
		.m0_readdata             (svsd_s1_agent_m0_readdata),                //                .readdata
		.m0_readdatavalid        (svsd_s1_agent_m0_readdatavalid),           //                .readdatavalid
		.m0_read                 (svsd_s1_agent_m0_read),                    //                .read
		.m0_waitrequest          (svsd_s1_agent_m0_waitrequest),             //                .waitrequest
		.m0_writedata            (svsd_s1_agent_m0_writedata),               //                .writedata
		.m0_write                (svsd_s1_agent_m0_write),                   //                .write
		.rp_endofpacket          (svsd_s1_agent_rp_endofpacket),             //              rp.endofpacket
		.rp_ready                (svsd_s1_agent_rp_ready),                   //                .ready
		.rp_valid                (svsd_s1_agent_rp_valid),                   //                .valid
		.rp_data                 (svsd_s1_agent_rp_data),                    //                .data
		.rp_startofpacket        (svsd_s1_agent_rp_startofpacket),           //                .startofpacket
		...
		.rf_sink_ready           (svsd_s1_agent_rsp_fifo_out_ready),         //         rf_sink.ready
		.rf_sink_valid           (svsd_s1_agent_rsp_fifo_out_valid),         //                .valid
		.rf_sink_startofpacket   (svsd_s1_agent_rsp_fifo_out_startofpacket), //                .startofpacket
		.rf_sink_endofpacket     (svsd_s1_agent_rsp_fifo_out_endofpacket),   //                .endofpacket
		.rf_sink_data            (svsd_s1_agent_rsp_fifo_out_data),          //                .data
		.rf_source_ready         (svsd_s1_agent_rf_source_ready),            //       rf_source.ready
		.rf_source_valid         (svsd_s1_agent_rf_source_valid),            //                .valid
		.rf_source_startofpacket (svsd_s1_agent_rf_source_startofpacket),    //                .startofpacket
		.rf_source_endofpacket   (svsd_s1_agent_rf_source_endofpacket),      //                .endofpacket
		.rf_source_data          (svsd_s1_agent_rf_source_data),             //                .data
		.rdata_fifo_sink_ready   (avalon_st_adapter_003_out_0_ready),        // rdata_fifo_sink.ready
		.rdata_fifo_sink_valid   (avalon_st_adapter_003_out_0_valid),        //                .valid
		.rdata_fifo_sink_data    (avalon_st_adapter_003_out_0_data),         //                .data
		.rdata_fifo_sink_error   (avalon_st_adapter_003_out_0_error),        //                .error
		.rdata_fifo_src_ready    (svsd_s1_agent_rdata_fifo_src_ready),       //  rdata_fifo_src.ready
		.rdata_fifo_src_valid    (svsd_s1_agent_rdata_fifo_src_valid),       //                .valid
		.rdata_fifo_src_data     (svsd_s1_agent_rdata_fifo_src_data),        //                .data
		.m0_response             (2'b00),                                    //     (terminated)
		.m0_writeresponsevalid   (1'b0)                                      //     (terminated)
	);
	...
	altera_avalon_sc_fifo #(
		...
		.USE_ALMOST_FULL_IF  (0),
		.USE_ALMOST_EMPTY_IF (0)
	) svsd_s1_agent_rsp_fifo (
		.clk               (CLK_clk_clk),                              //       clk.clk
		.reset             (CPU_reset_reset_bridge_in_reset_reset),    // clk_reset.reset
		.in_data           (svsd_s1_agent_rf_source_data),             //        in.data
		.in_valid          (svsd_s1_agent_rf_source_valid),            //          .valid
		.in_ready          (svsd_s1_agent_rf_source_ready),            //          .ready
		.in_startofpacket  (svsd_s1_agent_rf_source_startofpacket),    //          .startofpacket
		.in_endofpacket    (svsd_s1_agent_rf_source_endofpacket),      //          .endofpacket
		.out_data          (svsd_s1_agent_rsp_fifo_out_data),          //       out.data
		.out_valid         (svsd_s1_agent_rsp_fifo_out_valid),         //          .valid
		.out_ready         (svsd_s1_agent_rsp_fifo_out_ready),         //          .ready
		.out_startofpacket (svsd_s1_agent_rsp_fifo_out_startofpacket), //          .startofpacket
		.out_endofpacket   (svsd_s1_agent_rsp_fifo_out_endofpacket),   //          .endofpacket
		.csr_address       (2'b00),                                    // (terminated)
		.csr_read          (1'b0),                                     // (terminated)
		.csr_write         (1'b0),                                     // (terminated)
		.csr_readdata      (),                                         // (terminated)
	...
	sistema_mm_interconnect_0_router_002 router_005 (
		.sink_ready         (svsd_s1_agent_rp_ready),                //      sink.ready
		.sink_valid         (svsd_s1_agent_rp_valid),                //          .valid
		.sink_data          (svsd_s1_agent_rp_data),                 //          .data
		.sink_startofpacket (svsd_s1_agent_rp_startofpacket),        //          .startofpacket
		.sink_endofpacket   (svsd_s1_agent_rp_endofpacket),          //          .endofpacket
		.clk                (CLK_clk_clk),                           //       clk.clk
		.reset              (CPU_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	sistema_mm_interconnect_0_router_002 router_008 (
	...
	sistema_mm_interconnect_0_router_003 router_009 (
	...
	sistema_mm_interconnect_0_rsp_demux rsp_demux_006 (
		.clk                (CLK_clk_clk),                           //       clk.clk
		.reset              (CPU_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	sistema_mm_interconnect_0_rsp_demux_001 rsp_demux_007 (
		.clk                (CLK_clk_clk),                            //       clk.clk
		.reset              (RAM_reset1_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	sistema_mm_interconnect_0_avalon_st_adapter #(
		...
		.in_clk_0_clk   (CLK_clk_clk),                           // in_clk_0.clk
		.in_rst_0_reset (CPU_reset_reset_bridge_in_reset_reset), // in_rst_0.reset
		.in_0_data      (svsd_s1_agent_rdata_fifo_src_data),     //     in_0.data
		.in_0_valid     (svsd_s1_agent_rdata_fifo_src_valid),    //         .valid
		.in_0_ready     (svsd_s1_agent_rdata_fifo_src_ready),    //         .ready
